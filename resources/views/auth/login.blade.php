                                ...
                                <div class="content">
                                    ...
                                    <form name="form" id="form1" action="" method="post" class="form-validate">
                                        ...
                                        <div class="form-group">
                                            <input id="uname" type="text" name="name" required autofocus
                                                value="{{ old('name') }}" data-msg="Please enter your username"
                                                class="input-material" autocomplete="name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @enderror
                                        </div><input type="submit" name="login" id="login" value="Login"
