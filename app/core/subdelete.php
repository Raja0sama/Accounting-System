 ...
 if(isset($_POST['btnshow'])){
  ...
  $amount = $_POST['amount'];
	...
	$query= "DELETE FROM `subaccount` WHERE `subid`=".$id;
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Delete Sub Account</strong></div>
...
<button type="submit" class="btn btn-primary" name="btnshow" id="btnadd">Delete SubAccount</button>
