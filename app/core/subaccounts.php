...
include("Connection.php");
 ...
 if(isset($_POST['btnshow'])){
	...
	$query= "INSERT INTO `subaccount`( `accountname`, `accountid`) VALUES ('$name','$chart')";
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Add Sub Account</strong></div>
...
$select1 = mysqli_query($con, "SELECT * FROM `subaccount`");
...
<br>
   ...
   <input class="form-control" id="name" name="name" placeholder="Enter Account Name"></input>
        ...
        <div class="col-md-4">
          <label class="col-md-12 control-label" for="selectbasic" class="form-control">Account ID</label>
...
?>
  ...
  <button type="submit" class="btn btn-primary" name="btnshow" id="btnadd">Create SubAccount</button>
...
<th class="table-danger">SubID</th>
<th>Account Name</th>
<th>Amount</th>
<th>Account ID</th>
<th>Options</th>
...
while($row = mysqli_fetch_array($select1))
{
  ...
  <td>'.$row[2].'</td>
  <td >'.$row[3].'</td>
<td><a href="subedit.php?id='.$row[0].'">Edit</a> | <a href="subdelete.php?id='.$row[0].'">delete</a></td>
  </tr>';
  echo $tabledata;
  }
