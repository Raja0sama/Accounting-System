        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Print Recipt Voucher</strong></div>
                  <div class="block-body">
                   <form name="form" id="form1" action="" method="post" class="form-horizontal">

<?php

 $query1 = mysqli_query($con,"Select * from recipt WHERE `id` = ".$id);
...
<button type="button" class="btn btn-primary" onclick="printJS ({ printable: 'printJS-form', type: 'html', header: 'Recipt Voucher' })">
    Print Form
 </button>     
   </div>
