...
if (isset($_POST['btnshow'])){
  header("Location: showreciptdesign.php");
}
...
if($value6 !="")
{
 $amountquery1111111 = "UPDATE `subaccount` SET `amount` = `amount` + ".$value6." where subid=".$checksubvalue5;
  $exe10111111 = mysqli_query($con,$amountquery1111111);
   ...
   $byvaluex = "SELECT accountname FROM `account` where accountid=".$_POST['byvalue'];
  $exe1a = mysqli_query($con,$byvaluex);
if($exe1a){
 ...
 $byquery = "UPDATE `account` SET `amount` = `amount` + ".$sum." where accountname='petty cash'";
  ...
  $query= "INSERT INTO `recipt`( `Date`, `chartaccount`, `mainaccount`, `subaccount`, `subaccount1`, `subaccount2`, `subaccount3`, `subaccount4`, `subaccount5`, `subvalue`, `subvalue1`, `subvalue2`, `subvalue3`, `subvalue4`, `subvalue5`, `by`, `Description`, `Total`) 
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Recipt Voucher</strong></div>
        ...
        <div class="col-md-5">
          <label class="col-md-4 control-label" for="selectbasic">No</label>
           ...
           <select id="selectbasic" name="selectbasic" class="form-control">
               <?php
$query = "SELECT id FROM recipt ORDER BY id DESC LIMIT 1;";
$exe = mysqli_query($con,$query);
if($exe){
                      ...
                      <div class="form-group row">
                        <div class="col-sm-12 ml-auto">
                          <button type="submit" class="btn btn-secondary">Cancel</button>
                                                    <button type="submit" class="btn btn-primary" name="btnshow" id="btnshow">Show All</button>
