...
<html>
  <head> 
    ...
    <title>ReciptVoucherRecords</title>
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Recipt Voucher Records</strong></div>
...
$select1 = mysqli_query($con, "SELECT * FROM `recipt`");
...
while($row = mysqli_fetch_array($select1))
{
 ...
 <td><a href="printrecipt.php?id='.$row[0].'">Print</a>
