...
include("Connection.php");
 ...
 if(isset($_POST['btnshow'])){
  $chartname = $_POST['chartname'];
	...
	$query= "INSERT INTO `chartaccount`( `accountname`, `chartid`) VALUES ('$chartname','$chartid')";
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Add Chart Account</strong></div>
...
<br>
   ...
   <input class="form-control" id="chartname" name="chartname" placeholder="Enter Account Name"></input>

        </div>
        <div class="col-md-4">
          <label class="col-md-12 control-label" for="selectbasic" class="form-control">Chart ID</label>

          <input class="col-md-9 form-control" id="chartid" name="chartid" placeholder="Enter ChartID"></input>
  ...
  <button type="submit" class="btn btn-primary" name="btnshow" id="btnadd">Create ChartAccount</button>
...
while($row = mysqli_fetch_array($select1))
{
  ...
  <td>'.$row[2].'</td>
  <td >'.$row[3].'</td>
	<td><a href="chartedit.php?id='.$row[0].'">Edit</a> | <a href="chartdelete.php?id='.$row[0].'">delete</a></td>
  </tr>';
  echo $tabledata;
  }
