 ...
 $id = $_GET['id'];
  ...
  header("Location: http://localhost/accounting/mainaccounts.php");
  }
 if(isset($_POST['btnshow'])){
  ...
  $amount = $_POST['amount'];
	...
	$query= "UPDATE `account` SET `accountname` = '".$name."',`amount` = '".$amount."',`chartid` = '".$chartid."' where accountid=".$id;
              ...
              <li><a href="paymentdesign.php"> <i class="fa fa-file-text-o"></i>Payment Voucher </a></li>
                <li><a href="reciptdesign.php"> <i class="fa fa-file-text-o"></i>Recipt Voucher </a></li>
                  ...
                  <ul id="exampledropdownDropdown1" class="collapse list-unstyled ">
                    ...
                    <li  class="active"><a href="mainaccounts.php">Main Account</a></li>
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Update Main Account</strong></div>
...
<?php
 ...
 $query1 = mysqli_query($con,"Select * from account WHERE `accountid` = ".$id);
...
<button type="submit" class="btn btn-primary" name="btnshow" id="btnadd">Update MainAccount</button>
