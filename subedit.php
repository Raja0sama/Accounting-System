 ...
 $id = $_GET['id'];
  ...
  header("Location: http://localhost/accounting/subaccounts.php");
  }
 if(isset($_POST['btnshow'])){
  ...
  $amount = $_POST['amount'];
	...
	$query= "UPDATE `subaccount` SET `accountname` = '".$name."',`amount` = '".$amount."',`accountid` = '".$chartid."' where subid=".$id;
              ...
              <li><a href="paymentdesign.php"> <i class="fa fa-file-text-o"></i>Payment Voucher </a></li>
                <li><a href="reciptdesign.php"> <i class="fa fa-file-text-o"></i>Recipt Voucher </a></li>
                  ...
                  <ul id="exampledropdownDropdown1" class="collapse list-unstyled ">
                    ...
                    <li  class="active"><a href="subaccounts.php">Sub Account</a></li>
                  </ul>
                </li>
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Update Sub Account</strong></div>
...
<?php
 ...
 $query1 = mysqli_query($con,"Select * from subaccount WHERE `subid` = ".$id);
   ...
   <input class="form-control" id="amount" name="amount" value="<?php echo $row[2] ?>"></input>
    ...
    <div class="col-sm-9">
      <div class="row">
		 ...
		 <div class="col-md-5">
          <label class="col-md-5 control-label" for="selectbasic">Account ID</label>
   <select name="chartid" class="form-control">
...
<button type="submit" class="btn btn-primary" name="btnshow" id="btnadd">Update SubAccount</button>
