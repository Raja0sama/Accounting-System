     ...
     <?php include("sidebar.php"); ?>     <div class="page-content">
        ...
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">ajdustment           </li>
          </ul>
        </div>
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Print Adjustemnt</strong></div>
                  <div class="block-body">
                   <form name="form" id="form1" action="" method="post" class="form-horizontal">

<?php

 $query1 = mysqli_query($con,"Select * from adjustment WHERE `id` = ".$id);
      ...
      <div class="row">
        <div class="col-md-5">
          <label class="col-md-4 control-label" for="selectbasic">No</label>
           ...
           <input type="text" id="selectbasic" name="selectbasic" class="form-control" value="<?php echo $row[0]; ?>">
        ...
        <div class="col-md-4">
          <label class="col-md-4 control-label" for="selectbasic" class="form-control">Date</label>
           ...
           <input type="text" id="datevalue" name="datevalue" class="form-control" value="<?php echo $row[1]; ?>"
                 />
       </div>
      </div>
    </div>
...
<div class="show_product" ></div>
   ...
   <div class="col-md-3">
     <label class="col-md-12   control-label" for="selectbasic">Main Account</label>

<input type="text" name="" id="mainvalue" name="mainvalue" class="form-control" value="<?php echo $row[3]; ?>">

</input>  </div>


<div class="col-md-3">
  <label class="col-md-12 control-label" for="selectbasic">Sub Account</label>

<input type="text" name="" id="subvalue" name="subvalue" class="form-control" value="<?php echo $row[4]; ?>">
    ...
    <div class="col-sm-12">
      <div class="row">
        <div class="col-md-3">
          <label class="col-md-12 control-label" for="selectbasic">Chart Of Account</label>
<div class="show_product" ></div>
   <input type="text" id="chartvalue1" name="chartvalue1" class="form-control" value="<?php echo $row[6]; ?>">
...
<input type="text" id="mainvalue1" name="mainvalue1" class="form-control" value="<?php echo $row[7]; ?>">
...
<input type="text" name="" id="subvalue1" name="subvalue1" class="form-control" value="<?php echo $row[8]; ?>">
...
<br>
                        ...
                        <div class="col-sm-5">
                          ...
                          <textarea class="form-control" id="description" name="description"><?php echo $row[10]; ?></textarea>
...
<button type="button" class="btn btn-primary" onclick="printJS ({ printable: 'printJS-form', type: 'html', header: 'Adjustment' })">
    Print Form
 </button>     
   </div>
